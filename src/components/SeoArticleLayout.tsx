  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 lg:py-20">
        <article className="prose prose-slate prose-lg lg:prose-xl max-w-none prose-headings:font-public-sans prose-a:text-orange-600 hover:prose-a:text-orange-700">
          ...
          <div className="mt-16 pt-8 border-t border-slate-200">
            <div className="bg-gradient-to-r from-orange-50 to-rose-50 rounded-3xl p-8 border border-orange-100 text-center">
              <h3 className="text-2xl font-bold font-public-sans text-slate-900 mb-4">अभी अपना Nazri Naksha बनाएं</h3>
