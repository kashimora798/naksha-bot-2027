  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden selection:bg-orange-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-xl rounded-2xl ring-1 ring-slate-200">
        <h1 className="text-4xl font-bold font-[Baloo_2] text-slate-900 mb-8 pb-4 border-b border-slate-100">Terms and Conditions</h1>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">ELIGIBILITY</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">DEFINITIONS</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">MERCHANT'S RIGHTS</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">YOUR RESPONSIBILITIES</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">PROHIBITED ACTIONS</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">LIMITATION OF LIABILITY</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">GUIDELINES FOR REVIEWS</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">GOVERNING LAWS & DISPUTE RESOLUTION</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">GRIEVANCE REDRESSAL</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-[Baloo_2]">DISCLAIMER</h2>
          <p className="text-slate-600 mb-6">
