  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden selection:bg-orange-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 sm:p-12 shadow-xl rounded-2xl ring-1 ring-slate-200">
        <h1 className="text-4xl font-bold font-public-sans text-slate-900 mb-8 pb-4 border-b border-slate-100">Terms and Conditions</h1>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">ELIGIBILITY</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">DEFINITIONS</h2>
          <ul className="list-disc pl-6 text-slate-600 space-y-3 mb-6">
            ...
            <li><strong>"Website"</strong> shall mean www.instamojo.com or the mobile application.</li>
          </ul>

          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">MERCHANT'S RIGHTS</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">YOUR RESPONSIBILITIES</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">PROHIBITED ACTIONS</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">LIMITATION OF LIABILITY</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">GUIDELINES FOR REVIEWS</h2>
          <p className="text-slate-600 mb-4">We may provide you areas on the Platform to leave reviews or ratings. When posting a review, you must comply with the following criteria:</p>
          <ul className="list-disc pl-6 text-slate-600 space-y-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">GOVERNING LAWS & DISPUTE RESOLUTION</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">GRIEVANCE REDRESSAL</h2>
          <p className="text-slate-600 mb-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-10 mb-4 font-public-sans">DISCLAIMER</h2>
          <p className="text-slate-600 mb-6">
